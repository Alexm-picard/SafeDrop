...
// AI-Assisted Areas: GET /api/dashboard/summary (ORG_ADMIN, SCRUM-103/SCRUM-102)
 ...
 * whole organisation — units per status, pending requests, overdue loans and 30 days of checkout
 * activity — which is why it is admin-only even though none of the individual numbers is sensitive on
 * its own (SCRUM-102, AT2).
 *
